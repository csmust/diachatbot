...
class Processor(object):
    ...
    def prediction(model, dataset, mode, batch_size, args):
        ...
        for text_batch, slot_batch, intent_batch in tqdm(dataloader, ncols=50):
            ...
            # 测试集 验证集 转为序列
            digit_text = dataset.bert_get_text(padded_text,digital=False) #将含有"[pad]"的文本序列化[['医', '生', '：', '你', '好', '，', '咳', '嗽', '是', ...], ['医', '生', '：', '如', '果', '没', '有', '这', '个', ...], ['医', '生', '：', '磨', '牙', '，', '晚', '上', '翻', ...], ['医', '生', '：', '大', '便', '怎', '么', '样', '？', ...], ['医', '生', '：', '现', '在', '可', '以', '吃', '点', ...], ['患', '者', '：', '大', '便', '经', '常', '干', "'", ...], ['医', '生', '：', '益', '生', '菌', '也', '可', '以', ...], ['患', '者', '：', '没', '发', '烧', '，', '也', '没', ...], ['医', '生', '：', '有', '没', '什', '么', '过', '敏', ...], ['医', '生', '：', '以', '前', '有', '气', '喘', '吗', ...], ['医', '生', '：', '咳', '嗽', '有', '几', '天', '了', ...], ['医', '生', '：', '可', '能', '有', '点', '积', '食', ...], ['医', '生', '：', '有', '发', '热', '过', '吗', '？', ...], ['患', '者', '：', '那', '该', '总', '么', '办', '<PAD>', ...], ...]

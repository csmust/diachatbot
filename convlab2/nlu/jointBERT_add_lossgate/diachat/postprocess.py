...
def recover_intent(dataloader, intent_logits, tag_logits, tag_mask_tensor, ori_word_seq, new2ori):
    ...
    return das
#tag_logits
# tensor([[ 7.4329,  1.3254,  2.9968,  ..., -0.9727, -0.6423, -2.9734],
#         [ 9.5865,  0.8437,  3.5719,  ..., -1.4956, -1.2179, -3.5057],
#         [ 9.6482,  0.7494,  3.7041,  ..., -1.4433, -1.2101, -3.6439],
#         ...,
#         [ 6.0222,  0.9918,  3.0826,  ..., -1.1112, -0.8586, -2.8849],
#         [ 6.3486,  1.0508,  3.1582,  ..., -1.0841, -0.6981, -2.7756],
#         [ 6.7296,  1.1940,  2.8223,  ..., -1.1036, -0.6821, -3.2503]],
#        device='cuda:0')
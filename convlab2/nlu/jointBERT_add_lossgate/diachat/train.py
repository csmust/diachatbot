...
from convlab2.nlu.jointBERT_add_lossgate.diachat.dataloader import Dataloader
from convlab2.nlu.jointBERT_add_lossgate.diachat.jointBERT import JointBERT
...
def train(CROSS_TRAIN=False,best_val_F1_list=[],args=None):
    ...
    print('-' * 20 + 'data' + '-' * 20)
    from convlab2.nlu.jointBERT_add_lossgate.diachat.postprocess import is_slot_da, calculateF1, recover_intent
    ...
    for step in range(1, max_step + 1):
        ...
        # alpha = alpha -lr*(slot_loss.item()-intent_loss.item())
        # end_time = time.time()

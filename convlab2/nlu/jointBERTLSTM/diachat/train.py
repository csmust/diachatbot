...
def train(CROSS_TRAIN=False,best_val_F1_list=[],args=None):
    ...
    if config['model']['finetune']:
        ...
        "myattention.output_proj.weight","myattention.input_proj.weight","lstm.weight","enc_i.self_attn.in_proj_weight","enc_i.self_attn.out_proj.weight"
        ,"enc_i.linear1.weight","enc_i.linear2.weight","enc_i.norm1.weight","enc_i.norm2.weight","enc_s.self_attn.in_proj_weight"
        ,"enc_s.self_attn.out_proj.weight","enc_s.linear1.weight","enc_s.linear2.weight","enc_s.norm1.weight","enc_s.norm2.weight",
        "CNN_NLP.conv1d_list.2.weight","CNN_NLP.conv1d_list.1.weight"]
        # ,"_conv.weight","dec_s.atte"
        attention = ["unflatselfattention1.scorer.weight","unflatselfattention2.scorer.weight","newselfattention1.k.weight","newselfattention1.q.weight","newselfattention1.v.weight","newselfattention2.k.weight","newselfattention2.q.weight","newselfattention2.v.weight"]

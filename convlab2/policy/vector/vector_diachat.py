...
#         self.sys_intent_domain_voc = json.load(open(sys_intent_domain_json))
...
#         self.all_domains = ['基本信息','行为','治疗','问题','运动','饮食']
    ...
    def generate_dict(self):
        ...
        for domain in domain_slots.keys():
            if domain == '基本信息':
                ...
                self.belief_state_domainslot2id[domain] = {'现状':domain_slots2id[domain], '解释':domain_slots2id[domain]}
                self.belief_state_id2domainslot[domain] = {'现状':id2domain_slots[domain], '解释':id2domain_slots[domain]}
    ...
    def state_vectorize(self, state):
        ...
        da = state['user_action'] # da必定为空，这里有点奇怪
...
if __name__ == '__main__':
    vec = DiachatVector('../../../data/diabetes/sys_da_voc.json','../../../data/diabetes/usr_da_voc.json','../../../data/diabetes/sys_domain_da_voc.json','../../../data/diabetes/user_domain_da_voc.json')

...
class MLE_Trainer():
    def __init__(self, cfg):
        ...
        vector = DiachatVector(sys_act_domain, usr_act_domain,sys_act_domain_slot,usr_act_domain_slot)
        ...
        self.policy = MultiDiscretePolicy(vector.state_dim, cfg['h_dim'], vector.sys_da_dim).to(device=DEVICE)#构建一个神经网络，入度为328，出度为155
        self.policy.eval()

...
if __name__ == '__main__':
    replaceFile('annotations_20221120.json','annotations_20221120_1.json')
    replace_affected_problem_wenhao('annotations_20221120_1.json','annotations_20221120_2.json')
    validate_annoation('annotations_20221120_2.json')
    check_turns('annotations_20221120_2.json')
